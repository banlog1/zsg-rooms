...
public final class MatchHud {
    ...
    public static void render(MatrixStack matrices, float tickDelta) {
        ...
        for (zsgrooms.modid.Player player : room.players) {
            ...
            client.textRenderer.drawWithShadow(matrices, name, x + 8, rowY, 0xFFFFFFFF);
            String stageText = stage > 0 ? stage + "/8  " + label : label;
            client.textRenderer.drawWithShadow(matrices, stageText, x + 13, rowY + 9, 0xFFB8B8B8);
            rowY += 20;
        }
    }
